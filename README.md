...
### Web & data
[Presentation-Maker](https://github.com/V1DeeK/Presentation-Maker) — учебный редактор презентаций на React/TypeScript. [WEB-2025](https://github.com/V1DeeK/WEB-2025) — вёрстка и frontend. [BD_Ispring](https://github.com/V1DeeK/BD_Ispring) — курс по базам данных.

</td>
<td width="50%" valign="top">

### C++ & algorithms
[flappyBird](https://github.com/V1DeeK/flappyBird) и [game_project_cpp](https://github.com/V1DeeK/game_project_cpp) на SFML. [CL](https://github.com/V1DeeK/CL) — прототип в духе Crimsonland. [combinatorics_ispring](https://github.com/V1DeeK/combinatorics_ispring) и [algoritms-and-data-structures-](https://github.com/V1DeeK/algoritms-and-data-structures-) — математика, алгоритмы, структуры данных.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,cs,python,html,css,js,ts,react,qt,opencv,dotnet,postgres,git,github,vscode&theme=dark&perline=8" alt="Skills"/>
</p>
